...
The dashboard draws a **board**, chosen when the link is made. Twenty-nine
starting points, grouped by the screen they were composed for:

| | |
|---|---|
| a phone | one column, three things, four seconds standing up |
| a laptop | overview · does anything need me · the waiting queue · what is waiting on an answer · how today went · everything at once · only the machine · what has gone wrong · cost against output · pull requests · for your boss · where it went · per project · which model is working |
...
project name off the screen they are sat in front of. Two of the twenty-nine are
