...
TARGETS=${VERIFY_TARGETS:-"check panes-check install-check sudo-check head-check first-run-check board-check pages-check render-check stress-check restart-check scale-check tls-check release-check"}
