...
TARGETS=${VERIFY_TARGETS:-"check panes-check install-check sudo-check isolation-check head-check first-run-check pages-check chat-check resources-check render-check stress-check restart-check scale-check tls-check release-check"}
