...
const DICT = {
  ...
  'vnc.title': { zh: 'VNC 屏幕', en: 'VNC displays' },
  'vnc.why': {
    zh: '把一块 VNC 屏幕放在终端旁边看。面板只转发字节，地址来自这里存的行，不来自浏览器。',
    en: 'Watch a VNC display next to the terminal. The panel forwards bytes; the address comes from the row stored here, never from the browser.',
  },
  'vnc.name': { zh: '名字', en: 'Name' },
  'vnc.host': { zh: '主机', en: 'Host' },
  'vnc.password': { zh: '密码', en: 'Password' },
  'vnc.passwordSet': { zh: '已设置，留空不动', en: 'Set — leave blank to keep' },
  'vnc.passwordNote': {
    zh: 'VNC 密码以明文存在数据库里；它只有 8 字节，本来就不是保密手段。',
    en: 'A VNC password is stored in the clear; it is eight bytes and was never a way to keep a secret.',
  },
  'vnc.viewOnly': { zh: '只看', en: 'View only' },
  'vnc.add': { zh: '添加', en: 'Add' },
  'vnc.save': { zh: '保存', en: 'Save' },
  'vnc.remove': { zh: '删掉', en: 'Remove' },
  'vnc.saveFailed': { zh: '没保存上', en: 'Not saved' },
  'vnc.none': { zh: '还没有 VNC 屏幕，去设置里加一个', en: 'No displays yet — add one in settings' },
  'vnc.live': { zh: '连着', en: 'Live' },
  'vnc.connecting': { zh: '正在连', en: 'Connecting' },
  'vnc.stalled': { zh: '没反应', en: 'Not responding' },
  'vnc.closed': { zh: '断了', en: 'Disconnected' },
  'vnc.refused': { zh: '不允许连这个地址', en: 'Address not allowed' },
  'vnc.retry': { zh: '重连', en: 'Reconnect' },
  'panel.vnc': { zh: '屏幕', en: 'Screen' },
