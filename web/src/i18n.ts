...
const DICT = {
  ...
  'preview.sandboxed': { zh: '在沙箱里渲染，不联网。', en: 'Drawn in a sandbox, with no network.' },
  'preview.scriptsOn': { zh: '脚本已开', en: 'Scripts on' },
  'preview.scriptsOff': { zh: '脚本已关', en: 'Scripts off' },
  'preview.scriptsHint': {
    zh: '只对这个文件生效，关掉预览就重置',
    en: 'This file only, and it resets when you close this',
  },
  ...
  'git.onlyWhenAsked': { zh: '只有按了这个按钮才会联网。', en: 'Nothing here reaches the network until you press that.' },
