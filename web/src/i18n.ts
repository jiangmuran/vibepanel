...
const DICT = {
  ...
  'chat.coalesce': { zh: '攒几秒再发（0 为 3 秒）', en: 'Seconds to gather changes (0 = 3)' },
  ...
  'chat.everyoneIncludes': { zh: '包括：', en: 'Includes:' },
  'chat.goneDestination': { zh: '{name}（已不在）', en: '{name} (gone)' },
  ...
  'notify.chatOpen': { zh: '设置聊天', en: 'Set up chat' },
