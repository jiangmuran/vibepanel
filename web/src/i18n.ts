...
const DICT = {
  ...
  'chat.unavailable': { zh: '这个面板没有启动聊天桥。', en: 'The chat bridge is not running on this panel.' },
  'chat.channels': { zh: '通道', en: 'Channels' },
  'chat.channelsLead': {
    zh: '每个聊天应用一张卡。最近一条消息何时到达，是它是否真的通了的唯一证据。',
    en: 'One card per app. When a message last arrived is the only proof a channel really works.',
  },
  ...
  'chat.needsHello': { zh: '{n} 条推送在等对方先开口', en: '{n} pushes waiting for a hello' },
  ...
  'chat.removeChannelBody': {
    zh: '它的凭据和配对的人都会一起删掉。',
    en: 'Its credentials and everyone paired on it go with it.',
  },
  'chat.peers': { zh: '配对', en: 'People' },
  'chat.peersLead': {
    zh: '第一次给机器人发消息的人会收到一个配对码，在这里输入才能开始。',
    en: 'Whoever messages the bot first gets a code. Enter it here to let them in.',
  },
  'chat.pairingCode': { zh: '配对码', en: 'Pairing code' },
  'chat.pair': { zh: '配对', en: 'Pair' },
  'chat.pairedOk': { zh: '已配对', en: 'Paired' },
  'chat.pairFailed': { zh: '没有这个配对码', en: 'No such code' },
  'chat.noPeers': { zh: '还没有人跟机器人说过话。', en: 'Nobody has messaged the bot yet.' },
  'chat.block': { zh: '拉黑', en: 'Block' },
  'chat.unblock': { zh: '解除', en: 'Unblock' },
  ...
  'chat.routes': { zh: '推送规则', en: 'Routes' },
  'chat.routesLead': {
    zh: '从上往下，第一条命中的规则决定推给谁。都不命中时用默认规则。',
    en: 'Top down; the first rule that matches decides who is told. Otherwise the default applies.',
  },
  ...
  'chat.matchStates': { zh: '状态（不选即全部）', en: 'States (none = all)' },
  'chat.matchKinds': { zh: '消息类型（不选即全部）', en: 'Message kinds (none = all)' },
  'chat.matchTools': { zh: '工具（不选即全部）', en: 'Tools (none = all)' },
  'chat.matchProjects': { zh: '项目（不选即全部）', en: 'Projects (none = all)' },
  'chat.any': { zh: '全部', en: 'all' },
  'chat.to': { zh: '推给', en: 'To' },
  'chat.toEveryone': { zh: '所有已配对的人', en: 'everyone paired' },
  'chat.toNobody': { zh: '没选人：这条规则只用来静音', en: 'nobody: this rule silences' },
  'chat.screenshot': { zh: '截图', en: 'Screenshot' },
  'chat.shotAuto': { zh: '全屏程序时', en: 'full-screen programs' },
  'chat.shotAlways': { zh: '总是', en: 'always' },
  'chat.shotNever': { zh: '从不', en: 'never' },
  'chat.coalesce': { zh: '合并等待（秒，0 为默认）', en: 'Settle (seconds, 0 = default)' },
  'chat.quietHours': { zh: '安静时段', en: 'Quiet hours' },
  'chat.body': { zh: '带上 agent 说的话', en: 'Include what the agent said' },
  ...
  'chat.assistantLead': {
    zh: '一个无头 agent 读你的句子，决定送给哪个会话；写操作都要你回复 ok。',
    en: 'A headless agent reads your sentence and picks the session; every write waits for your ok.',
  },
  ...
  'chat.harness': { zh: '用哪个', en: 'Harness' },
  'chat.model': { zh: '模型', en: 'Model' },
  'chat.modelHint': { zh: '留空用默认', en: 'empty for the default' },
  'chat.profile': { zh: '启动档案（环境变量）', en: 'Launch profile (environment)' },
  ...
  'chat.keysLead': {
    zh: '「允许」在每个工具里是不同的键。用 tmux 的键名，空格分隔。',
    en: '"Allow" is a different key in each tool. tmux key names, separated by spaces.',
  },
  'chat.keysHint': {
    zh: '另外三个的默认值照抄 Claude Code，未实测。',
    en: 'The opencode, Kimi and zcode defaults copy Claude Code and were not measured.',
  },
