...
const DICT = {
  ...
  'mon.cpu': { zh: 'CPU', en: 'CPU' },
  'mon.memory': { zh: '内存', en: 'Memory' },
  'mon.swap': { zh: '交换', en: 'Swap' },
  'mon.disk': { zh: '磁盘', en: 'Disk' },
  'mon.reading': { zh: '读取中…', en: 'Reading…' },
  'mon.cores': { zh: '{n} 核', en: '{n} cores' },
  'mon.sampling': { zh: '采样中…', en: 'sampling…' },
  'mon.unavailable': { zh: '读不到', en: 'unavailable' },
  'mon.free': { zh: '{n} 可用', en: '{n} free' },
  'mon.of': { zh: '{used} / {total}', en: '{used} of {total}' },
  'mon.up': { zh: '已运行 {d}', en: 'up {d}' },
  'mon.perSession': { zh: '各会话占用', en: 'Per session' },
  'mon.noSessions': { zh: '没有在跑的会话', en: 'Nothing running' },
  'mon.procs': { zh: '{n} 个进程', en: '{n} processes' },
  'mon.oneProc': { zh: '1 个进程', en: '1 process' },
  'mon.noProc': {
