...
const DICT = {
  ...
  'page.title': { zh: '分享页面', en: 'Share pages' },
  'page.why': {
    zh: '自己写 HTML 的分享页。让 agent 写，在旁边预览，满意了再发布。',
    en: 'Share pages in your own HTML. An agent writes it, you preview it beside it, then publish.',
  },
  ...
  'page.draws': { zh: '显示', en: 'Shows' },
  'page.drawsBoard': { zh: '看板', en: 'Board' },
