...
const DICT = {
  ...
  'chat.needsHello': { zh: '{n} 条等对方先发一句', en: '{n} held until they message first' },
  ...
  'chat.coalesce': { zh: '合并等待（秒，0 即 3 秒）', en: 'Wait before sending (s, 0 = 3)' },
  ...
  'chat.keysHint': {
    zh: 'opencode、Kimi、zcode 默认照抄 Claude Code。',
    en: 'The opencode, Kimi and zcode defaults copy Claude Code.',
  },
