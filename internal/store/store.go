...
var migrations = []func(tx *sql.Tx) error{
	...
	// v15: a remark on a share link, and a lock on its board.
	//
	...
	// v27: chat -- what a session said, and the IM peers it is said to.
	//
...
// lookup by id and a listing.
//
// Here rather than beside either of them: two files each invented it
// independently and the package stopped compiling the day they met, which is
// the compiler catching what a reviewer would not have.
