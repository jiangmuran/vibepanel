...
func (s *Server) handleGit(w http.ResponseWriter, r *http.Request) {
	...
	// Through the cache, never straight at the working tree. This endpoint is
	// polled, by every open tab, and the whole of why that is affordable is in
	// internal/git/cache.go.
	snap, err := s.Git.Read(ctx, p.Path, recentCommits)
	if err != nil {
